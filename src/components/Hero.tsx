    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-muted">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            We Build SEO-Friendly Websites for Businesses
          </motion.h1>
          ...
          >
            Fast, responsive, and optimized websites that help your business grow online.
            From design to launch, we handle everything with expert care.
          </motion.p>
